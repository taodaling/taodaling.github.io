...
[Docker Zipkin](https://github.com/openzipkin/docker-zipkin)项目能够构建docker镜像，提供了脚本和[docker-compose.yml](https://github.com/openzipkin/docker-zipkin/blob/master/docker-compose.yml)用于启动预构建的镜像。最快速的方式是直接运行最新的镜像：
